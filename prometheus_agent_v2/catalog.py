    ...
    "java_jmx": [
        {
            ...
            "current_promql": "(avg by(job, instance) (process_cpu_usage * 100)) or (avg by(job, instance) (java_lang_operatingsystem_processcpuload * 100))",
            "range_promql": "(avg by(job, instance) (process_cpu_usage * 100)) or (avg by(job, instance) (java_lang_operatingsystem_processcpuload * 100))",
            "value_type": "percent",
            "unit": "%",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold", "burst", "sustained_growth"],
        ...
        },
        {
            ...
            "current_promql": "100 * ((sum by(job, instance) (jvm_memory_used_bytes{area=\"heap\"})) or (sum by(job, instance) (jvm_memory_bytes_used{area=\"heap\"})) or (sum by(job, instance) (java_lang_memory_heapmemoryusage_used))) / ((sum by(job, instance) (jvm_memory_max_bytes{area=\"heap\"} > 0)) or (sum by(job, instance) (jvm_memory_bytes_max{area=\"heap\"} > 0)) or (sum by(job, instance) (java_lang_memory_heapmemoryusage_max > 0)))",
            "range_promql": "100 * ((sum by(job, instance) (jvm_memory_used_bytes{area=\"heap\"})) or (sum by(job, instance) (jvm_memory_bytes_used{area=\"heap\"})) or (sum by(job, instance) (java_lang_memory_heapmemoryusage_used))) / ((sum by(job, instance) (jvm_memory_max_bytes{area=\"heap\"} > 0)) or (sum by(job, instance) (jvm_memory_bytes_max{area=\"heap\"} > 0)) or (sum by(job, instance) (java_lang_memory_heapmemoryusage_max > 0)))",
            "value_type": "percent",
            "unit": "%",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold", "sustained_growth", "time_to_limit"],
            ...
            "critical": 90,
            "max_value": 100,
            "labels_to_keep": ["job", "instance", "area"],
        },
        {
            "id": "jvm_gc_time_rate",
            "name": "JVM GC Time Rate",
            "description": "Seconds spent in GC per second.",
            "current_promql": "(sum by(job, instance) (rate(jvm_gc_pause_seconds_sum[5m]))) or (sum by(job, instance) (rate(jvm_gc_collection_seconds_sum[5m]))) or (sum by(job, instance) (rate(java_lang_garbagecollector_collectiontime[5m]) / 1000))",
            "range_promql": "(sum by(job, instance) (rate(jvm_gc_pause_seconds_sum[5m]))) or (sum by(job, instance) (rate(jvm_gc_collection_seconds_sum[5m]))) or (sum by(job, instance) (rate(java_lang_garbagecollector_collectiontime[5m]) / 1000))",
            "value_type": "number",
            "unit": "s/s",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold", "burst", "sustained_growth"],
        ...
        },
        {
            ...
            "current_promql": "(max by(job, instance) (jvm_threads_live_threads)) or (max by(job, instance) (jvm_threads_current)) or (max by(job, instance) (java_lang_threading_threadcount))",
            "range_promql": "(max by(job, instance) (jvm_threads_live_threads)) or (max by(job, instance) (jvm_threads_current)) or (max by(job, instance) (java_lang_threading_threadcount))",
            "value_type": "number",
            "unit": "",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold", "burst", "sustained_growth"],
    ...
    "redis_exporter": [
        {
            ...
            "current_promql": "redis_up",
            "range_promql": "redis_up",
            "value_type": "number",
            "unit": "",
        ...
        },
        {
            ...
            "current_promql": "100 * (sum by(job, instance) (redis_memory_used_bytes)) / ((sum by(job, instance) (redis_memory_max_bytes > 0)) or (sum by(job, instance) (redis_config_maxmemory > 0)) or (sum by(job, instance) (redis_total_system_memory_bytes)))",
            "range_promql": "100 * (sum by(job, instance) (redis_memory_used_bytes)) / ((sum by(job, instance) (redis_memory_max_bytes > 0)) or (sum by(job, instance) (redis_config_maxmemory > 0)) or (sum by(job, instance) (redis_total_system_memory_bytes)))",
            "value_type": "percent",
            "unit": "%",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold", "burst", "sustained_growth", "time_to_limit"],
        ...
        },
        {
            ...
            "current_promql": "redis_connected_clients",
            "range_promql": "redis_connected_clients",
            "value_type": "number",
            "unit": "",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold", "burst", "sustained_growth"],
        ...
        },
        {
            ...
            "current_promql": "rate(redis_evicted_keys_total[5m])",
            "range_promql": "rate(redis_evicted_keys_total[5m])",
            "value_type": "number",
            "unit": "/s",
            "direction": "higher_is_bad",
        ...
        },
        {
            ...
            "current_promql": "rate(redis_rejected_connections_total[5m])",
            "range_promql": "rate(redis_rejected_connections_total[5m])",
            "value_type": "number",
            "unit": "/s",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold", "burst", "sustained_growth"],
    ...
    "rabbitmq_exporter": [
        {
            "id": "rabbitmq_up",
            "name": "RabbitMQ Up",
            "description": "RabbitMQ exporter availability.",
            "current_promql": "rabbitmq_up",
            "range_promql": "rabbitmq_up",
            "value_type": "number",
            "unit": "",
            "direction": "lower_is_bad",
            "analysis_methods": ["threshold"],
        ...
        {
            "id": "rabbitmq_queue_messages_ready",
            "name": "RabbitMQ Queue Messages Ready",
            "description": "Ready message backlog by queue.",
            "current_promql": "rabbitmq_queue_messages_ready",
            "range_promql": "rabbitmq_queue_messages_ready",
            "value_type": "number",
            "unit": "",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold", "burst", "sustained_growth", "time_to_limit"],
            "warning": 1000,
            "critical": 10000,
            "labels_to_keep": ["job", "instance", "vhost", "queue"],
        },
        {
            "id": "rabbitmq_queue_messages_unacknowledged",
            "name": "RabbitMQ Queue Messages Unacknowledged",
            "description": "Unacked messages by queue.",
            "current_promql": "rabbitmq_queue_messages_unacknowledged",
            "range_promql": "rabbitmq_queue_messages_unacknowledged",
            "value_type": "number",
            "unit": "",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold", "burst", "sustained_growth"],
        ...
        {
            "id": "rabbitmq_queue_consumers",
            "name": "RabbitMQ Queue Consumers",
            "description": "Queue consumer count.",
            "current_promql": "rabbitmq_queue_consumers",
            "range_promql": "rabbitmq_queue_consumers",
            "value_type": "number",
            "unit": "",
            "direction": "lower_is_bad",
            "analysis_methods": ["threshold"],
        ...
        },
        {
            ...
            "current_promql": "rabbitmq_node_mem_alarm",
            "range_promql": "rabbitmq_node_mem_alarm",
            "value_type": "number",
            "unit": "",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold"],
        ...
        },
        {
            ...
            "current_promql": "rabbitmq_node_disk_free_alarm",
            "range_promql": "rabbitmq_node_disk_free_alarm",
            "value_type": "number",
            "unit": "",
            "direction": "higher_is_bad",
            "analysis_methods": ["threshold"],
